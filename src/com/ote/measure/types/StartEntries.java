...
public class StartEntries implements Serializable{
	...
	private ArrayList<Map.Entry<String, String>> ListEntries;

	public ArrayList<Map.Entry<String, String>> getListEntries() {
		return ListEntries;
	}

	public void setListEntries(ArrayList<Map.Entry<String, String>> listEntries) {
	...
	public StartEntries(ArrayList<Map.Entry<String, String>> listEntries) {
		super();
		ListEntries = listEntries;
	}
