...
public class ControlType implements java.io.Serializable {
    ...
    public static final ControlType LINK = new ControlType(_LINK);
    public static final ControlType BUTTON = new ControlType(_BUTTON);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://diagnostic.ws.solvatio.iisy.com/", "controlType"));
    }
    /**
