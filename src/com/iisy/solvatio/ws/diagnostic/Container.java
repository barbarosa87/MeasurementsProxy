...
public class Container  extends com.iisy.solvatio.ws.diagnostic.AbstractContainer  implements java.io.Serializable {
    public Container() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://diagnostic.ws.solvatio.iisy.com/", "container"));
    }
