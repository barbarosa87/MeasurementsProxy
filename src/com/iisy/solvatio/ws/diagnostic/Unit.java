...
public class Unit implements java.io.Serializable {
    ...
    public static final Unit PIXELS = new Unit(_PIXELS);
    public static final Unit PERCENTAGE = new Unit(_PERCENTAGE);
    public java.lang.String getValue() { return _value_;}
    public static Unit fromValue(java.lang.String value)
          throws java.lang.IllegalArgumentException {
        Unit enumeration = (Unit)
            _table_.get(value);
        if (enumeration==null) throw new java.lang.IllegalArgumentException();
        return enumeration;
    }
    public static Unit fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://diagnostic.ws.solvatio.iisy.com/", "unit"));
    }
    /**
